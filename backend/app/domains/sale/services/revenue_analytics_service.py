...
from app.domains.sale.repositories.revenue_analytics_repository import (
    RevenueAnalyticsRepository,
)
from app.domains.sale.repositories.sold_item_analytics_repository import (
...
class RevenueAnalyticsService:
    ...
    def list_accumulated_revenue_day(tenant_id, period):
        ...
        _, end_date = PeriodService.get_period_range(period)
        revenue = 0
